...
const MantenedorPaisInfo = (props) => {
  ...
  return (
    <div>
        <div className="bg-primary Form_Cabecera">
          <IntlMessages id="label.InformacionPais"/>
        </div>
        <div className="Form_Cuerpo">
            <div className="row">
              ...
              <Button variant="contained" className="bg-primary text-white jr-btn jr-btn-sm mt-3 rounded-lg" onClick={()=>{
                if(controls.id>0){
                  dispatch(putRegisterPais(controls))
                }else{
                  dispatch(postRegisterPais(controls))
                }
                }}>
...
export default MantenedorPaisInfo;
