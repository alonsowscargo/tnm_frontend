...
console.log('rol',Usuario.usuario.fk_rol);
        return (
            <React.Fragment>
              {Usuario.usuario.fk_rol==6 || Usuario.usuario.fk_rol==3 &&
                <div class="container mt-5">
                  <Link to="/app/recepcion" title="Jambo">
                  <div className="cards">
                      <div className="cards-body content-space-between">
                          <div className="card-data">
                              <h5 className="title-h5 font-weight-700 text-capitalize">
                              <IntlMessages id="label.recepcionCarga"/>
                              </h5>
                          </div>
              ...
              <div className="row">
                {Usuario.usuario.fk_rol!==11 && Usuario.usuario.fk_rol!==10 && Usuario.usuario.fk_rol!==6 && Usuario.usuario.fk_rol!==3 && Usuario.usuario.fk_rol!==4 && !activeList && clientNotifications.length>0 &&

                  <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                  <div className="profile-intro card shadow  border-0 text-center">
                      <div className="pi-header">
                          <div className="card-image layer">
                              <img className="avatar-circle" src={userPng} alt="Team Member"/>
                          </div>
                      </div>
                      <div className="pi-content">
                          <p><h2><b>Atención</b></h2></p>
                          <p><h5>Existen <b>{clientNotifications.length}</b> clientes con información incompleta</h5></p>
                      </div>
                      <div className="pi-footer">
                      <Button variant="contained" className="bg-default jr-btn jr-btn-sm mt-3 mb-3 rounded-lg" onClick={()=>{
                            dispatch(setShowListClientesSrldDashboard(true));
                          }}>
                  ...
                  <div className="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                    <div className="row">
                      {!activeList && Usuario.usuario.fk_rol!==6 && Usuario.usuario.fk_rol!==3 && Usuario.usuario.fk_rol!==4 && Usuario.usuario.fk_rol!==11 && Usuario.usuario.fk_rol!==10 &&
                      <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                      <FormGroup>
                            <Label for="label">Reporte:</Label>
                            <Input
                            type="select" 
                            id="tipo_producto"
                            name="tipo_producto"
                            ...
                            >
                            <option key={0} value={0}>Propuestas Comerciales</option>
                            <option key={1} value={1}>Clientes Registrados</option>
                            <option key={2} value={2}>Recepciones</option>
                            </Input>
                      ...
                      {Usuario.usuario.fk_rol!==6 && Usuario.usuario.fk_rol!==3 && Usuario.usuario.fk_rol!==4 && Usuario.usuario.fk_rol!==11 && Usuario.usuario.fk_rol!==10 &&
                ...
                {Usuario.usuario.fk_rol!==6 && Usuario.usuario.fk_rol!==3 && Usuario.usuario.fk_rol!==4 && Usuario.usuario.fk_rol!==11 && Usuario.usuario.fk_rol!==10 && activeList && clientNotifications.length>0 &&
                <React.Fragment>
                    <h1>Listado de clientes con información incompleta</h1>
                    <DataTable
                            columns={columns}
                            data={filteredItems}
                            pagination
                        ...
                        // selectableRows
                           // conditionalRowStyles={conditionalRowStyles}
                            ...
                            /> 
                    <Button variant="contained" className="bg-info jr-btn jr-btn-sm mt-3 mb-3 rounded-lg" onClick={()=>{
                        dispatch(setShowListClientesSrldDashboard(false));
                     }}>
                ...
                <ToastContainer />
                {/*<ModalClientes open={modalEditarCliente.open} onToggle={closeModalEditarClienteDashboard}/>*/}
